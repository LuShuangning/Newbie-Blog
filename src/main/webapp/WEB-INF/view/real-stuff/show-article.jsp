...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://www.syninglu.space/static/css/real-stuff/show-article.css">
...
<body>
	...
	<script src="http://www.syninglu.space/static/js/front-end/show-article.js"></script>
</body>
</html>