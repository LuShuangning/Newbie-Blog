...
<body>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-md-3 col-sm-6">
							...
							<div class="thumbnail">
								<a href="store/index.do#/book" title="储物间~~" target="_blank">
								<img src="/static/img/index/img01.jpg" alt=""></a>
								<h3>储物间</h3>
								<p>双儿和朋友们放东西的地方</p>
							</div>
						...
						<div class="col-md-3 col-sm-6">
							...
							<div class="thumbnail">
								<a href="realStuff/index.do" title="广播站里的程序员" target="_blank"><img src="/static/img/index/img02.jpg" alt=""></a>
								<h3>干货数据库</h3>
								<p>代码、程序员的日常</p>
							</div>
	...
	<script src="/static/js/front-end/index.js"></script>
